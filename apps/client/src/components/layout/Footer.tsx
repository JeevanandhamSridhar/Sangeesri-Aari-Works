...
const footerLinks = {
  Services: [
    ...
    { label: 'Custom Saree Matching', href: '/gallery' },
    { label: 'Express Order Slots', href: '/services#express' },
  ],
  'Gallery & Academy': [
    { label: 'Design Gallery', href: '/gallery' },
    { label: 'Bridal Blouse Portfolio', href: '/gallery' },
    { label: 'Aari Work Showcase', href: '/gallery' },
    { label: 'Academy Courses', href: '/academy' },
    { label: 'Student Admissions', href: '/academy' },
